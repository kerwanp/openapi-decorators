...
test('@ApiOperation', () => {
  ...
  const operationMetadata = OperationMetadataStorage.getMetadata(
    MyController.prototype,
    'operation'
  )
  const parameterMetadata = OperationParameterMetadataStorage.getMetadata(
    MyController.prototype,
    'operation'
  )
